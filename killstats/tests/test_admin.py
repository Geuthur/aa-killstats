...
from killstats.admin import KillstatsAuditAdmin, clear_cache_zkb
...
class TestKillstatsAuditAdmin(TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.site = AdminSite()
        cls.killstats_audit_admin = KillstatsAuditAdmin(KillstatsAudit, cls.site)
        cls.killstats_audit = KillstatsAudit.objects.get(id=1)
    ...
    def test_clear_cache_for_selected(self, mock_clear_cache_zkb):
        ...
        queryset = KillstatsAudit.objects.filter(id=self.killstats_audit.pk)
